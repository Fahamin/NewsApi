...
//Customize Circular Reveal
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.mipmap.usback_round); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("International Top News"); //change your app name here
    ...
    public void animationsFinished() {
        final Intent intent = new Intent(spalsh_screen.this, DetailsActivity.class);
